          ...
          {session?.user ? (
            ...
            <>
              ...
              <Link
                ...
                className="inline-flex h-9 items-center justify-center rounded-xl bg-purple-600 px-4 py-2 text-xs font-bold text-white shadow-lg shadow-purple-500/20 transition-all hover:bg-purple-700 hover:shadow-purple-500/40 hover:-translate-y-0.5 gap-1"
              >
